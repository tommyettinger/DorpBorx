...
//	Configuration
//
var fileLoadingImage = "/images/lightbox/ndrw_loader.gif";		
...
Lightbox.prototype = {
	...
	initialize: function() {	
		...
		//						<img src="/wp-content/themes/waterlily-20/images/loading.gif">
		//					</a>
		//				</div>
		//			</div>
		//		</div>
		...
		//						<img src="/wp-content/themes/waterlily-20/images/close.gif">
		//					</a>
		//				</div>
		//			</div>
		//		</div>
		...
		objPrevLink.setAttribute('rel','null');
		objHoverNav.appendChild(objPrevLink);
		
		var objNextLink = document.createElement("a");
		objNextLink.setAttribute('id','nextLink');
		objNextLink.setAttribute('href','#');
		objNextLink.setAttribute('rel','null');
		...
		objBottomNavCloseLink.setAttribute('rel','null');
