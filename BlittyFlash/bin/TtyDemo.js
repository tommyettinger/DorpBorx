...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("assets/fonts/balloonifont-100.png",loader);
	ApplicationMain.total++;
	var loader1 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/fonts/balloonifont-128.png",loader1);
	ApplicationMain.total++;
	var loader2 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/fonts/balloonifont-trimmed.png",loader2);
	ApplicationMain.total++;
	var loader3 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/fonts/dartsma-100.png",loader3);
	ApplicationMain.total++;
	var loader4 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/fonts/eunuch-100x100.png",loader4);
	ApplicationMain.total++;
	var loader5 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/fonts/monaco-brogue-8.png",loader5);
	ApplicationMain.total++;
	var loader6 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/fonts/oryx-brogue-small.png",loader6);
	ApplicationMain.total++;
	var loader7 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/fonts/oryx-brogue.png",loader7);
	ApplicationMain.total++;
	var loader8 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/fonts/ScrollPacked.png",loader8);
	ApplicationMain.total++;
	var loader9 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/fonts/zodiac-narrow-100.png",loader9);
	ApplicationMain.total++;
	var loader10 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/fonts/zodiac-square-100.png",loader10);
	ApplicationMain.total++;
	var loader11 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/fonts/zodiac.png",loader11);
	ApplicationMain.total++;
...
ApplicationMain.preloader_onComplete = function(event) {
	...
	if(Reflect.field(com.jdaydev.blitty.TtyDemo,"main") == null) {
		var mainDisplayObj = new com.jdaydev.blitty.TtyDemo();
		if(js.Boot.__instanceof(mainDisplayObj,browser.display.DisplayObject)) nme.Lib.get_current().addChild(mainDisplayObj);
	} else Reflect.field(com.jdaydev.blitty.TtyDemo,"main").apply(com.jdaydev.blitty.TtyDemo,[]);
}
...
browser.events.TimerEvent = function(type,bubbles,cancelable) {
	if(cancelable == null) cancelable = false;
	if(bubbles == null) bubbles = false;
	browser.events.Event.call(this,type,bubbles,cancelable);
};
$hxClasses["browser.events.TimerEvent"] = browser.events.TimerEvent;
browser.events.TimerEvent.__name__ = ["browser","events","TimerEvent"];
browser.events.TimerEvent.__super__ = browser.events.Event;
browser.events.TimerEvent.prototype = $extend(browser.events.Event.prototype,{
	__class__: browser.events.TimerEvent
});
...
browser.utils.Timer = function() { }
$hxClasses["browser.utils.Timer"] = browser.utils.Timer;
browser.utils.Timer.__name__ = ["browser","utils","Timer"];
browser.utils.Timer.__super__ = browser.events.EventDispatcher;
browser.utils.Timer.prototype = $extend(browser.events.EventDispatcher.prototype,{
	...
	,__onInterval: function() {
		...
		if(this.repeatCount != 0 && ++this.currentCount >= this.repeatCount) {
			this.stop();
			evtCom = new browser.events.TimerEvent("timerComplete");
			evtCom.target = this;
		}
		var evt = new browser.events.TimerEvent("timer");
		evt.target = this;
		this.dispatchEvent(evt);
...
com.jdaydev = {}
com.jdaydev.blitty = {}
com.jdaydev.blitty.Console = function(Font,Columns,Rows) {
	...
	this.tty = new com.jdaydev.blitty.ConsoleCursor(this);
};
$hxClasses["com.jdaydev.blitty.Console"] = com.jdaydev.blitty.Console;
com.jdaydev.blitty.Console.__name__ = ["com","jdaydev","blitty","Console"];
com.jdaydev.blitty.Console.__super__ = browser.display.Sprite;
com.jdaydev.blitty.Console.prototype = $extend(browser.display.Sprite.prototype,{
	draw: function() {
		this.get_graphics().clear();
		var _g1 = 0, _g = this.columns;
		while(_g1 < _g) {
			var x = _g1++;
			var _g3 = 0, _g2 = this.rows;
			while(_g3 < _g2) {
				var y = _g3++;
				var idx = x + y * this.columns;
				var ct = 6 * idx;
				var g = this.glyph[idx];
				var c = this.fg[idx];
				this.fgArray[ct + 2] = g;
				this.fgArray[ct + 3] = (c >> 16 & 255) * (1 / 255);
				this.fgArray[ct + 4] = (c >> 8 & 255) * (1 / 255);
				this.fgArray[ct + 5] = (c & 255) * (1 / 255);
			}
		}
		this.font.sheet.drawTiles(this.get_graphics(),this.fgArray,false,4);
	}
	,rebuildTilesheetArrays: function() {
		this.fgArray = [];
		this.bgArray = [];
		var stw = this.font.tw;
		var sth = this.font.th;
		...
		while(_g1 < _g) {
			...
			while(_g3 < _g2) {
				var x = _g3++;
				var ct = 6 * (x + y * this.columns);
				this.fgArray[ct] = x * stw;
				this.fgArray[ct + 1] = y * sth;
				this.fgArray[ct + 2] = 0;
				this.fgArray[ct + 3] = 0;
				this.fgArray[ct + 4] = 0;
				this.fgArray[ct + 5] = 0;
		...
		this.set_width(stw * this.columns);
		this.set_height(sth * this.rows);
	}
	,resize: function(w,h) {
		var _glyph = this.glyph;
		var _fg = this.fg;
		var _bg = this.bg;
		this.cells = w * h;
		this.glyph = [];
		...
		this.bg = [];
		if(_glyph != null) {
			var _g1 = 0, _g = this.rows < h?this.rows:h;
			while(_g1 < _g) {
				var y = _g1++;
				var _g3 = 0, _g2 = this.columns < w?this.columns:w;
				while(_g3 < _g2) {
					var x = _g3++;
					this.glyph[x + y * w] = _glyph[x + y * this.columns];
					this.fg[x + y * w] = _fg[x + y * this.columns];
					this.bg[x + y * h] = _bg[x + y * this.columns];
				}
			}
		}
		this.columns = w;
		this.rows = h;
		this.rebuildTilesheetArrays();
	}
	,lowlevelplot: function(idx,Glyph,Color) {
		this.glyph[idx] = Glyph;
		this.fg[idx] = Color;
	}
	,__class__: com.jdaydev.blitty.Console
});
com.jdaydev.blitty.ConsoleCursor = function(console) {
	this.tty = console;
	this.x = 0;
	this.y = 0;
	this.x1 = 0;
	this.y1 = 0;
	this.width = console.columns;
	this.height = console.rows;
};
$hxClasses["com.jdaydev.blitty.ConsoleCursor"] = com.jdaydev.blitty.ConsoleCursor;
com.jdaydev.blitty.ConsoleCursor.__name__ = ["com","jdaydev","blitty","ConsoleCursor"];
com.jdaydev.blitty.ConsoleCursor.prototype = {
	clip: function(X1,Y1,Width,Height) {
		var sub = new com.jdaydev.blitty.ConsoleCursor(this.tty);
		sub.x1 = this.x1 + X1;
		sub.y1 = this.y1 + Y1;
		if(sub.x1 + Width > this.width) Width = this.width - sub.x1;
		if(sub.y1 + Height > this.height) Height = this.height - sub.y1;
		sub.width = Width;
		sub.height = Height;
		if(sub.x1 < 0) {
			sub.width += sub.x1;
		...
		sub.cursorfg = this.cursorfg;
		return sub;
	}
	,rgb: function(R,G,B,A) {
		if(A == null) A = 255;
		this.cursorfg = (A & 255) << 24 | (R & 255) << 16 | (G & 255) << 8 | B & 255;
		return this;
	}
	,fg: function(Color,Alpha) {
		if(Alpha == null) Alpha = 255;
		this.cursorfg = Color & 16777215 | (Alpha & 255) << 24;
		return this;
	}
	,wipe: function() {
		this.at(0,0);
		...
		while(_g1 < _g) {
			...
			while(_g3 < _g2) {
				var cx = _g3++;
				this.tty.lowlevelplot(rowidx + cx,0,this.cursorfg);
			}
			rowidx += this.tty.columns;
		}
		return this.at(0,0);
	}
	...
	,print: function(msg) {
		var _g1 = 0, _g = msg.length;
		while(_g1 < _g) {
			var i = _g1++;
			this.put(msg.charCodeAt(i));
		}
		return this;
	}
	,put: function(Glyph) {
		if(this.x > 0 && this.x < this.width && this.y > 0 && this.y < this.height) this.tty.lowlevelplot(this.idx,Glyph,this.cursorfg);
		this.x++;
		this.idx++;
		return this;
	}
	,at: function(X,Y) {
		this.x = X;
		this.y = Y;
		this.idx = this.x1 + this.x + (this.y1 + this.y) * this.tty.columns;
		return this;
	}
	,__class__: com.jdaydev.blitty.ConsoleCursor
}
com.jdaydev.blitty.ConsoleFont = function(Bmp,Columns,Rows) {
	this.bmp = Bmp;
	this.sheet = this.splitBmp(this.bmp,Columns,Rows);
};
$hxClasses["com.jdaydev.blitty.ConsoleFont"] = com.jdaydev.blitty.ConsoleFont;
com.jdaydev.blitty.ConsoleFont.__name__ = ["com","jdaydev","blitty","ConsoleFont"];
com.jdaydev.blitty.ConsoleFont.fromAsset = function(FontName,Columns,Rows) {
	return new com.jdaydev.blitty.ConsoleFont(nme.installer.Assets.getBitmapData(FontName),Columns,Rows);
}
com.jdaydev.blitty.ConsoleFont.prototype = {
	splitBmp: function(bmp,w,h) {
		var tilesheet = new browser.display.Tilesheet(bmp);
		this.tw = Math.floor((bmp._nmeTextureBuffer != null?bmp._nmeTextureBuffer.width:0) / w);
		this.th = Math.floor((bmp._nmeTextureBuffer != null?bmp._nmeTextureBuffer.height:0) / h);
		var _g = 0;
		while(_g < h) {
			var y = _g++;
			var _g1 = 0;
			while(_g1 < w) {
				var x = _g1++;
				tilesheet.addTileRect(new browser.geom.Rectangle(x * this.tw,y * this.th,this.tw,this.th));
			}
		}
		this.numGlyphs = w * h;
		return tilesheet;
	}
	,__class__: com.jdaydev.blitty.ConsoleFont
}
com.jdaydev.blitty.TtyDemo = function() {
	this.enemyY = 3;
	this.enemyX = 3;
	this.playerY = 5;
	this.playerX = 5;
...
$hxClasses["com.jdaydev.blitty.TtyDemo"] = com.jdaydev.blitty.TtyDemo;
com.jdaydev.blitty.TtyDemo.__name__ = ["com","jdaydev","blitty","TtyDemo"];
com.jdaydev.blitty.TtyDemo.__super__ = browser.display.Sprite;
com.jdaydev.blitty.TtyDemo.prototype = $extend(browser.display.Sprite.prototype,{
	this_onEnterFrame: function(event) {
		var thisFrameTime = haxe.Timer.stamp();
		var delta = thisFrameTime - this.lastFrameTime;
		this.lastFrameTime = thisFrameTime;
		var animleft = 5;
		var animtop = 3 + 3 * Math.cos(3.5 * thisFrameTime) | 0;
		var _g = 0;
		while(_g < 80) {
			var x = _g++;
			var _g1 = 0;
			while(_g1 < 40) {
				var y = _g1++;
				this.back.tty.rgb(50,50,50).at(x,y).put(0);
			}
		}
		this.back.draw();
		var _g = 0;
		while(_g < 80) {
			...
			while(_g1 < 40) {
				var y = _g1++;
				this.tv.tty.at(x,y).put(32);
			}
		}
		this.sprs.tty.clip(2,2,18,16).wipe().fg(15645559).at(2,4).print("v").print("s").print("s").print("w").skip(1).print("v").print("s").print("s").print("w").fg(15645559).at(2,5).print("t").skip(2).print("x").print("s").print("y").skip(2).print("t").fg(15645559).at(2,6).print("t").skip(7).print("t").fg(15645559).at(2,7).print("x").print("w").skip(5).print("v").print("y").fg(15645559).at(3,8).print("t").skip(5).print("t").fg(15645559).at(2,9).print("v").print("y").skip(5).print("x").print("w").fg(15645559).at(2,10).print("t").skip(7).print("t").fg(15645559).at(2,11).print("t").skip(2).print("v").print("s").print("w").skip(2).print("t").fg(15645559).at(2,12).print("x").print("s").print("s").print("y").skip(1).print("x").print("s").print("s").print("y").fg(16729224).at(2 + this.playerX,4 + this.playerY).print("1").fg(6715289).at(2 + this.enemyX,4 + this.enemyY).print("g");
		if(this.game_over == true) {
			this.tv.tty.clip(4,1,22,16).rgb(255,0,0).at(3,3).print(" GAME OVER!");
			this.sprs.tty.clip(2,1,10,16).fg(16777215).at(2,2).print("ggggg");
			this.tv.draw();
			this.sprs.draw();
			return;
		}
	...
	,this_onKeyMove: function(event) {
		if(this.game_over == true) nme.Lib.close();
		if(event.keyCode == 40) {
			if(com.jdaydev.blitty.TtyDemo.passable[this.playerY + 1][this.playerX] == true) this.playerY = this.playerY + 1;
		} else if(event.keyCode == 38) {
			if(com.jdaydev.blitty.TtyDemo.passable[this.playerY - 1][this.playerX] == true) this.playerY = this.playerY - 1;
		} else if(event.keyCode == 37) {
			if(com.jdaydev.blitty.TtyDemo.passable[this.playerY][this.playerX - 1] == true) this.playerX = this.playerX - 1;
		} else if(event.keyCode == 39) {
			if(com.jdaydev.blitty.TtyDemo.passable[this.playerY][this.playerX + 1] == true) this.playerX = this.playerX + 1;
		}
		com.jdaydev.blitty.TtyDemo.passable[this.enemyY][this.enemyX] = true;
		var ds = [false,false,false,false];
		if(com.jdaydev.blitty.TtyDemo.passable[this.enemyY + 1][this.enemyX] == true) ds[0] = true;
		if(com.jdaydev.blitty.TtyDemo.passable[this.enemyY - 1][this.enemyX] == true) ds[1] = true;
		if(com.jdaydev.blitty.TtyDemo.passable[this.enemyY][this.enemyX - 1] == true) ds[2] = true;
		if(com.jdaydev.blitty.TtyDemo.passable[this.enemyY][this.enemyX + 1] == true) ds[3] = true;
		var ranger = [0,1,2,3];
		de.polygonal.ds.ArrayUtil.shuffle(ranger);
		var _g = 0;
		while(_g < ranger.length) {
			var d = ranger[_g];
			++_g;
			if(ds[d]) {
				switch(d) {
		...
		if(this.enemyX == this.playerX && this.enemyY == this.playerY) this.game_over = true;
		com.jdaydev.blitty.TtyDemo.passable[this.enemyY][this.enemyX] = false;
	}
	,initialize: function() {
		...
		this.tv = new com.jdaydev.blitty.Console(com.jdaydev.blitty.ConsoleFont.fromAsset("assets/fonts/eunuch-100x100.png",100,100),80,40);
		this.back = new com.jdaydev.blitty.Console(com.jdaydev.blitty.ConsoleFont.fromAsset("assets/fonts/eunuch-100x100.png",100,100),80,40);
		this.sprs = new com.jdaydev.blitty.Console(com.jdaydev.blitty.ConsoleFont.fromAsset("assets/fonts/ScrollPacked.png",16,16),40,40);
		this.addChild(this.back);
		this.addChild(this.tv);
		this.addChild(this.sprs);
		this.addEventListener(browser.events.Event.ENTER_FRAME,$bind(this,this.this_onEnterFrame));
		nme.Lib.get_current().get_stage().addEventListener(browser.events.KeyboardEvent.KEY_DOWN,$bind(this,this.this_onKeyMove));
		this.lastFrameTime = haxe.Timer.stamp();
	}
	,__class__: com.jdaydev.blitty.TtyDemo
});
var de = {}
de.polygonal = {}
de.polygonal.ds = {}
...
nme.installer.Assets.initialize = function() {
	if(!nme.installer.Assets.initialized) {
		nme.installer.Assets.resourceNames.set("assets/fonts/balloonifont-100.png","assets/fonts/balloonifont-100.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/balloonifont-100.png","image");
		nme.installer.Assets.resourceNames.set("assets/fonts/balloonifont-128.png","assets/fonts/balloonifont-128.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/balloonifont-128.png","image");
		nme.installer.Assets.resourceNames.set("assets/fonts/balloonifont-trimmed.png","assets/fonts/balloonifont-trimmed.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/balloonifont-trimmed.png","image");
		nme.installer.Assets.resourceNames.set("assets/fonts/dartsma-100.png","assets/fonts/dartsma-100.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/dartsma-100.png","image");
		nme.installer.Assets.resourceNames.set("assets/fonts/eunuch-100x100.png","assets/fonts/eunuch-100x100.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/eunuch-100x100.png","image");
		nme.installer.Assets.resourceNames.set("assets/fonts/monaco-brogue-8.png","assets/fonts/monaco-brogue-8.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/monaco-brogue-8.png","image");
		nme.installer.Assets.resourceNames.set("assets/fonts/oryx-brogue-small.png","assets/fonts/oryx-brogue-small.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/oryx-brogue-small.png","image");
		nme.installer.Assets.resourceNames.set("assets/fonts/oryx-brogue.png","assets/fonts/oryx-brogue.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/oryx-brogue.png","image");
		nme.installer.Assets.resourceNames.set("assets/fonts/ScrollPacked.png","assets/fonts/ScrollPacked.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/ScrollPacked.png","image");
		nme.installer.Assets.resourceNames.set("assets/fonts/zodiac-narrow-100.png","assets/fonts/zodiac-narrow-100.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/zodiac-narrow-100.png","image");
		nme.installer.Assets.resourceNames.set("assets/fonts/zodiac-square-100.png","assets/fonts/zodiac-square-100.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/zodiac-square-100.png","image");
		nme.installer.Assets.resourceNames.set("assets/fonts/zodiac.png","assets/fonts/zodiac.png");
		nme.installer.Assets.resourceTypes.set("assets/fonts/zodiac.png","image");
...
com.jdaydev.blitty.TtyDemo.passable = [[false,false,false,false,true,false,false,false,false],[false,true,true,false,false,false,true,true,false],[false,true,true,true,true,true,true,true,false],[false,false,true,true,true,true,true,false,false],[true,false,true,true,true,true,true,false,true],[false,false,true,true,true,true,true,false,false],[false,true,true,true,true,true,true,true,false],[false,true,true,false,false,false,true,true,false],[false,false,false,false,true,false,false,false,false]];
